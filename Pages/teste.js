...
let tempData = new data(atualData);
let fData = tempData.getData() + '/' + (tempData.getMonth() + 1) + '/' + tempData.getFullYear();
let fTime = "Horas: " + tempData.getHoras() + 'minutos ' + tempData.getMinutes();
setTextodata (fData + '/n' + fTime)
